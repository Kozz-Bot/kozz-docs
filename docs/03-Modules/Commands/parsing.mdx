...
| Command                                 | Module                           | Method                               | Immediate Arg    | ArgName | Arg Value  |
| --------------------------------------- | -------------------------------- | ------------------------------------ | ---------------- | ------- | ---------- |
| !test                                   | <Color color="blue">test</Color> | <Color color="green">default</Color> | null             | null    | null       |
| !test 20                                | <Color color="blue">test</Color> | <Color color="green">20</Color>      | null             | null    | null       |
| !test --hasArgs                         | <Color color="blue">test</Color> | <Color color="green">default</Color> | null             | hasArgs | true       |
| !test foo --amount 30                   | <Color color="blue">test</Color> | <Color color="green">foo</Color>     | null             | amount  | 30         |
| !test foo --name John Doe               | <Color color="blue">test</Color> | <Color color="green">foo</Color>     | null             | name    | "John Doe" |
| !test foo search the web--name John Doe | <Color color="blue">test</Color> | <Color color="green">foo</Color>     | "search the web" | name    | "John Doe" |
